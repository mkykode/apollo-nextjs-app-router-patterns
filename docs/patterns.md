...
| `/cached`     | `query()` + Next.js Data Cache (`revalidate`, tags) | On the server, at most once a minute per query | Finished markup, prerendered      | Empty                               | Server Action + `updateTag`          |
